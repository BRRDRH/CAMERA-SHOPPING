...
/* 상단 메인, 서브 타이틀  */
.t_title{ color: #5ad2ff; font-size:2.5em; text-align:center; font-weight: bold; margin:35px 0;}
/* 중단 - 로그인 입력창 */
.f_input{ width: 450px;text-align:center; border:4px solid #5ad2ff; padding:10px;border-radius:10px; margin:0 auto;}
