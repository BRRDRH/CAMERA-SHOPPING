...
public class ReviewDAO {
		...
		public void insertReview(ReviewDTO review) {
			String sql = "insert into board(member_id, product_id, subject, content) values(?, ?, ?, ?)";
		...
		public List<ReviewDTO> getReviewList(int start, int size, int product_id) {
			...
			try {
				...
				// 1단계 : 리뷰 번호, 회원 아이디, 상품 아이디, 리뷰 제목, 리뷰 내용, 리뷰 등록일, 리뷰 조회수의 7가지 정보를 review에 저장
		...
		public ReviewDTO getBoard(int num) {
		...
		// 상품 리뷰 수정 메소드
		public void updateBoard(ReviewDTO review) {
